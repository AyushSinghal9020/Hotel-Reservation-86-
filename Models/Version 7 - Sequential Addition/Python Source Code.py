...
from sklearn.metrics import accuracy_score # Accurcay Socre
...
model_6 = Sequential()
model_6.add(Dense(10 , activation = "sigmoid" , input_dim = 10))
model_6.add(Dense(10 , activation = "sigmoid" , input_dim = 10))
model_6.add(Dense(1 , activation = "sigmoid"))

model_6.compile(loss = "binary_crossentropy" , optimizer = "Adam" , metrics = ["accuracy"])

y_log = model_6.predict(X_test)
y_pred = np.where(y_log > 0.5 , 1 , 0)
print(accuracy_score(Y_test , y_pred))
model_6_info = model_6.fit(X_train , Y_train , epochs = 100 , validation_split = 0.2)
